...
router.get('/organisation/:organisationId', validate(getResponseBySurveySchema), getResponsesByOrganisation);

// Route to get responses by survey ID
router.get('/survey/:surveyId', validate(getResponseBySurveySchema), getResponsesBySurvey);
