...
// Development seeder - generates smaller amounts of data dynamically
const seedDevDatabase = async () => {
    try {
        console.log('🌱 Starting dynamic development database seeding...');
        ...
        // Create 3 organisations dynamically
        ...
        createdOrganisations.forEach((org, orgIndex) => {
            ...
            // Create 2 surveys per organisation
            for (let i = 0; i < 2; i++) {
                const questions = [];
        ...
        createdOrganisations.forEach(org => {
            // Create 8 feedbacks per organisation
            for (let i = 0; i < 8; i++) {
                feedbacks.push({
                    organisationId: org._id,
        ...
        console.log('\n🎉 Dynamic development database seeding completed successfully!');
        console.log('\n📊 Summary:');
...
export default seedDevDatabase;
